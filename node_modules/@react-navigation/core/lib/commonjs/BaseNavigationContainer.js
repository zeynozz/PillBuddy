...
const BaseNavigationContainer = exports.BaseNavigationContainer = /*#__PURE__*/React.forwardRef(function BaseNavigationContainer({
  ...
  const [state, getState, setState, scheduleUpdate] = (0, _useSyncState.useSyncState)(() => getPartialState(initialState == null ? undefined : initialState));
  ...
  const builderContext = React.useMemo(() => ({
    ...
    scheduleUpdate,
    stackRef
  }), [addListener, addKeyedListener, onDispatchAction, onOptionsChange, scheduleUpdate]);
